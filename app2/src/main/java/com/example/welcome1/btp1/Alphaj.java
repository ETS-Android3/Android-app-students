...
public class Alphaj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Button j1,j2;
        ImageButton b2,b6;
        final MediaPlayer A2=MediaPlayer.create(this,R.raw.jail);
        final MediaPlayer A6=MediaPlayer.create(this,R.raw.jeans);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_alphaj);
        final MediaPlayer J1=MediaPlayer.create(this,R.raw.j1);
        ...
        final MediaPlayer J2=MediaPlayer.create(this,R.raw.j2);
