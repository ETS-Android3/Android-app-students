...
public class Alpham extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alpham);
        Button l1,l2;
        ImageButton b2,b6;
        final MediaPlayer A2=MediaPlayer.create(this,R.raw.lemon);
        final MediaPlayer A6=MediaPlayer.create(this,R.raw.arm);
        final MediaPlayer L1=MediaPlayer.create(this,R.raw.m1);
        ...
        final MediaPlayer L2=MediaPlayer.create(this,R.raw.m2);
