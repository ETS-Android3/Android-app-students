        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            d1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/f1.m4a");
                    mediaPlayer.start();
                }
            });
            ...
            d2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/f2.m4a");
                    mediaPlayer.start();
                }
            });
            b2=(ImageButton)this.findViewById(R.id.imageButton7);
            bitmap=getBitmapFromURL("http://192.168.43.223/drawable/chef.png");
            ...
            b2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/chef.mp3");
                    mediaPlayer.start();
                }
            });
            b6=(ImageButton)this.findViewById(R.id.imageButton8);
            bitmap=getBitmapFromURL("http://192.168.43.223/drawable/elf.png");
            ...
            b6.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/elf.mp3");
                    mediaPlayer.start();
                }
            });
    }
