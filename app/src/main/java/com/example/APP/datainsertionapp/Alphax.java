    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        d1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/x1.m4a");
                mediaPlayer.start();
            }
        });
        ...
        d2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/x2.m4a");
                mediaPlayer.start();
            }
        });
        b2=(ImageButton)this.findViewById(R.id.imageButton7);
        bitmap=getBitmapFromURL("http://192.168.43.223/drawable/exit.gif");
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/exit.mp3");
                mediaPlayer.start();
            }
        });
        b6=(ImageButton)this.findViewById(R.id.imageButton8);
        bitmap=getBitmapFromURL("http://192.168.43.223/drawable/axe.png");
        ...
        b6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/axe.mp3");
                mediaPlayer.start();
            }
        });
    }
