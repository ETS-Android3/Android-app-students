    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        d1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/e1.m4a");
                mediaPlayer.start();
            }
        });
        ...
        d2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/e2.m4a");
                mediaPlayer.start();
            }
        });
        ...
        bitmap=getBitmapFromURL("http://192.168.43.223/drawable/leg.png");
        ...
        b6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/leg.mp3");
                mediaPlayer.start();
            }
        });
    }
