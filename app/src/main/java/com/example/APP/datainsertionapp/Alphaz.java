    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        j1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/z1.m4a");
                mediaPlayer.start();
            }
        });
        ...
        j2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/z2.m4a");
                mediaPlayer.start();
            }
        });
        b2=(ImageButton)this.findViewById(R.id.imageButton7);
        bitmap=getBitmapFromURL("http://192.168.43.223/drawable/zero.png");
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/zero.mp3");
                mediaPlayer.start();
            }
        });
        b6=(ImageButton)this.findViewById(R.id.imageButton8);
        bitmap=getBitmapFromURL("http://192.168.43.223/drawable/razor.jpg");
        ...
        b6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer=myTask.doInBackground("http://192.168.43.223/raw/razor.mp3");
                mediaPlayer.start();
            }
        });
    }
